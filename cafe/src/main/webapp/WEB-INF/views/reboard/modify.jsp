...
$(function(){
	$('#writeBtn').click(function(){
		if($('#subject').val() == "") {
			...
			$('#writeForm').attr("action", "${root}/reboard/modify").submit();
		}
	});
});
</script>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<b>자유게시판</b> &nbsp;<font style="font-size: 8pt">|</font>&nbsp; 자유로운 글을 올리는 공간입니다<br>
		</td>
		<td align="right"></td>
	</tr>
	<tr>
...
<table border="0" cellpadding="5" cellspacing="0" width="630" style="table-layout: fixed">
	...
	<tr valign="top">
		<td width="95" nowrap style="padding-left: 8px; padding-top: 10px">
			<img src="${root}/img/board/e_dot.gif" width="4" height="4" border="0" align="absmiddle"> <b>제목</b>
		</td>
		<td colspan="5">
	...
	<tr>
		<td width="620" nowrap style="padding-left: 8px; padding-top: 10px" colspan="5">
			...
			<b>글내용</b>
			<textarea name="content" class="inp_02" cols="67" rows="25" scrollbars="no">${article.content}</textarea>
		</td>
	</tr>
</table>
	...
	<tr>
		<td align="center">
			<a href="javascript:writeArticle();">
				<img src="${root}/img/board/btn_register.gif" id="writeBtn" width="42" height="21" border="0" name="register" alt="등록">
			</a>
			<a href="javascript:history.back();">
				<img src="${root}/img/board/b_cancel.gif" width="42" height="21" border="0" name="cencel" alt="취소">
			</a>
		</td>
	</tr>
</table>
