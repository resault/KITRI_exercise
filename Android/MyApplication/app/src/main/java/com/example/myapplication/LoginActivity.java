...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("LoginActivity", "Login_onCreate");
    }

    @Override
    protected void onStart() {
        super.onStart();
        Log.i("LoginActivity", "Login_onStart");
    ...
    protected void onResume() {
        super.onResume();
        Log.i("LoginActivity", "Login_onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.i("LoginActivity", "LoginActivity_onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.i("LoginActivity", "Login_onStop");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("LoginActivity", "Login_onRestart");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("LoginActivity", "Login_onDestroy");
    }
...
//        startActivity(intent);
        ...
        new Thread() {
            public void run() {
                String urlStr = "http://192.168.14.61/myeljstl/login";
                InputStream is = null;
                try {
                    //서버로 요청
