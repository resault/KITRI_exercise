...
import com.kitri.dto.ExchangeRate;
...
public class ExchangeRateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread() {
            public void run() {
                //url 설정
                String urlStr = "https://www.koreaexim.go.kr/site/program/financial/exchangeJSON";
                urlStr += "?authkey=9nEexxzYx9Sbh7np9SXqfiOzVky9kLM5";
                urlStr += "&searchdate=20190604";
                urlStr += "&data=AP01";
                ...
                try {
                    ...
                    int responseCode = con.getResponseCode(); //응답상태 코드값
...
//                        });
                        ...
                        final List<ExchangeRate> listExchangeRate = mapper.readValue(str, new TypeReference<ArrayList<ExchangeRate>>(){});
                        ...
                        for(int i=0; i<listExchangeRate.size(); i++){
                            ExchangeRate exchageRate = listExchangeRate.get(i);
...
//
                                ...
                                spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                    ...
                                    public void onItemSelected(AdapterView<?> adapterView, View view, int index, long l) {
                                        ExchangeRate exchangeRate = listExchangeRate.get(index);
                                        TextView tv_spinner_result = (TextView)findViewById(R.id.tv_spinner_result);
